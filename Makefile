...
build: check-ocb
	...
	@echo ""
	@echo "✓ Build complete! Binary: ./dist/prometheus-opentelemetry-collector"
	@echo ""

# Run the collector
run:
	@if [ ! -f ./dist/prometheus-opentelemetry-collector ]; then \
	...
	@echo ""
	./dist/prometheus-opentelemetry-collector --config otel-config.yaml
...
validate:
	...
	./dist/prometheus-opentelemetry-collector validate --config otel-config.yaml
...
components:
	...
	@echo ""
	./dist/prometheus-opentelemetry-collector components
...
version:
	...
	./dist/prometheus-opentelemetry-collector --version